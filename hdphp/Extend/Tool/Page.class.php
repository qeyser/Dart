...
class Page
{
    ...
    protected function pre()
    {
        if ($this->selfPage > 1 && $this->selfPage <= $this->totalPage) {
            return "<li><a href='" . $this->getUrl($this->selfPage - 1) . "' class='previous'>ئالدىنقى بەت</a></li>";
        }
        return "<li class='previous'><a href='' class='fui-arrow-left'>ئالدىنقى بەت</a></li>";
    }
    ...
    public function next()
    {
        ...
        if ($this->selfPage < $this->totalPage) {
            return "<li><a href='" . $this->getUrl($this->selfPage + 1) . "' class='fui-arrow-right'>كېيىنكى بەت</a></li>";
        }
        return "<li class='next'>كېيىنكى بەت</li>";
    }
...
";
    ...
    public function first()
    {
        ...
        return $this->selfPage - $this->pageRow > 1 ? "<li><a href='" . $this->getUrl(1) . " class='first'>{$first}</a></li>" : "";
    }
    ...
    {
        $end = $this->desc ['end'];
        return $this->selfPage < $this->totalPage - $this->pageRow ? "<li><a href='" . $this->getUrl($this->totalPage) . "' class='end'>{$end}</a></li>" : "";
    }
    ...
    {
        return "<li class='count'><a>[ جەمئىي {$this->totalPage} بەت ] - [ {$this->totalRow} يازما ]</a></li>";
    }
